...
namespace Control_Gimmnacio
{
    public partial class vVender : Form
    {
        ...
        {
            InitializeComponent();
            string q = "select  idProduc as id, nomProduc as Nombre, precio as Precio from product where cantidad !=0 and cantidad >0";
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                string qCanti = "select cantidad as s from product where idProduc = '" + dataGridView1.CurrentRow.Cells[0].Value.ToString() + "' AND nomProduc='" + dataGridView1.CurrentRow.Cells[1].Value.ToString() + "'";
